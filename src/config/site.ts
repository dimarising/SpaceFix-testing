...
export const contact = {
  ...
  address: 'Ul. Malinowa 16/U1, Warszawa',
  addressLine1: 'ul. Bohaterów Warszawy 20',
  addressLine2: '02-495 Warszawa Ursus',
  mapsHref: 'https://www.google.com/maps/place/SpaceFix+-+Serwis+Apple+,+Samsung+,+Xiaomi/@52.1931235,20.8805978,17z',
  mapsDirectionsHref:
    'https://www.google.com/maps/dir/?api=1&destination=ul.+Bohater%C3%B3w+Warszawy+20,+02-495+Warszawa',
  mapsEmbedSrc:
  ...
  facebook: 'https://www.facebook.com/share/186wnHCJRX/?mibextid=wwXIfr',
